...
-- CREATE DATABASE "voc-app-db" ----------------------------
CREATE DATABASE IF NOT EXISTS `voc-app-db` CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `voc-app-db`;
-- ---------------------------------------------------------
...
ALTER TABLE `dictionary` DROP FOREIGN KEY `lnk_word_eng_dict_dictionary`;
...
ALTER TABLE `word_eng` DROP FOREIGN KEY `lnk_rus_eng_word_eng`;
...
ALTER TABLE `word_eng` DROP FOREIGN KEY `lnk_word_eng_dict_word_eng`;
...
ALTER TABLE `word_eng` DROP FOREIGN KEY `word_eng_ibfk_1`;
...
ALTER TABLE `word_rus` DROP FOREIGN KEY `lnk_rus_eng_word_rus`;
...
ALTER TABLE `word_rus` DROP FOREIGN KEY `word_rus_ibfk_1`;
...
-- CREATE LINK "lnk_word_rus_dict_dictionary" --------------
ALTER TABLE `dictionary` DROP FOREIGN KEY `lnk_word_rus_dict_dictionary`;


ALTER TABLE `dictionary`
	ADD CONSTRAINT `lnk_word_rus_dict_dictionary` FOREIGN KEY ( `id` )
	REFERENCES `word_rus_dict`( `dict_id` )
	ON DELETE Cascade
	ON UPDATE Cascade;
-- ---------------------------------------------------------


-- CREATE LINK "lnk_word_rus_dict_word_rus" ----------------
ALTER TABLE `word_rus` DROP FOREIGN KEY `lnk_word_rus_dict_word_rus`;


ALTER TABLE `word_rus`
	ADD CONSTRAINT `lnk_word_rus_dict_word_rus` FOREIGN KEY ( `word_rus_id` )
	REFERENCES `word_rus_dict`( `word_rus_id` )
	ON DELETE Cascade
	ON UPDATE Cascade;
-- ---------------------------------------------------------
